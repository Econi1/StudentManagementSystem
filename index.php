<?php include('shared/_header.php');?>
  ...
  <main>
    <div class="big-wrapper light">
      <img src="./public/images/log2_2.png" alt="" class="shape" />
      ...
      <div class="container mt-5">
        <div class="row">
          ...
          <div class="col-12 col-md-6 image-box">
            ...
            <img src="./public/images/log2_2.png" alt="Person Image" class="person" />
          </div>
        </div>
      </div>
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="./public/images/card.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./public/images/card1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="./public/images/card.jpg" class="d-block w-100" alt="...">
            </div>
